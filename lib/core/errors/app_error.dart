...
extension AppErrorCodeExt on AppErrorCode {
  String get code {
    switch (this) {
      case AppErrorCode.authInvalidCredentials:     return 'AUTH_001';
      case AppErrorCode.authEmailTaken:             return 'AUTH_002';
      case AppErrorCode.authTokenExpired:           return 'AUTH_003';
      case AppErrorCode.authUnknown:                return 'AUTH_099';
      case AppErrorCode.networkUnavailable:         return 'NET_001';
      case AppErrorCode.networkServerError:         return 'NET_002';
      case AppErrorCode.networkTimeout:             return 'NET_003';
      ...
      case AppErrorCode.unknown:                    return 'ERR_000';
    }
  }

  String get userMessage {
    switch (this) {
      case AppErrorCode.authInvalidCredentials:     return 'Incorrect email or password';
      case AppErrorCode.authEmailTaken:             return 'This email is already registered';
      case AppErrorCode.authTokenExpired:           return 'Session expired, please log in again';
      case AppErrorCode.authUnknown:                return 'Authentication failed';
      case AppErrorCode.networkUnavailable:         return 'No internet connection';
      case AppErrorCode.networkServerError:         return 'Server error, please try again';
      case AppErrorCode.networkTimeout:             return 'Request timed out';
      ...
      case AppErrorCode.unknown:                    return 'Something went wrong';
    }
  }
